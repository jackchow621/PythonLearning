...
from tmall.Common import Common
            ...
            while num <= maxPage and num < 20:  # 每个商品的评论我最多取20 页，每页有20条评论，也就是每个商品最多只取 400 个评论
                try:
                    ...
                    while (n < len(rateList)):
                        ...
                        n += 1
                    print(num)
                    sql = "insert into bra(bra_id, bra_color, bra_size, resource, comment, comment_time)  value(null, %s, %s, %s, %s, %s)"
